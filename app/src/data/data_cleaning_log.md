...
2.   **[Complete Quality Sweep]** Processed remaining 85 rows to remove invalid data and systematically correct information:
     ...
     b. [Removal] 18 rows deleted because although the song, artist and primary feeling did not contain exclusively NA values, the song, artist, and primary feeling lacked sufficient written context to achieve both of the succeeding measures as presented in *Data Correction Measures*:
     ...
     f. [Correction] Corrected information in [song_name], [artist_name] and [primary_feeling] columns for 37 remaining rows in the sequence.

     g. [Addition] Added the YouTube Music song URL in the [youtube_music_url] column for 37 remaining rows in the sequence.
