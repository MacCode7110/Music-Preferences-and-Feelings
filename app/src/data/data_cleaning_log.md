...
## Song Research Questions
    ...
    3. If the song was officially and originally released through a standard recording LP, standard recording EP, or single, then are the relevant standard recording LP, standard recording EP, or single release formats in YouTube Music? Do the relevant standard recording LP, standard recording EP, or single release formats in YouTube Music accurately maintain a corresponding original structure? To accurately maintain a corresponding original structure, a release format preserves the original count, list, and ordering of songs. If a release format accurately maintains a corresponding original structure, then the release format is structurally correct.
