...
input_csv_path = csv_directory / "survey_data_master_sonic_feature_calculations.csv"
output_csv_path = csv_directory / "survey_data_master_sonic_feature_standardization.csv"
