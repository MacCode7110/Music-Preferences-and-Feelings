...
>
> There is some probability that the release of a song in one particular format contains different engineering output and sonic qualities compared to the release of a song in a different particular format.
>
