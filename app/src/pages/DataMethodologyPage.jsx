      ...
      <div className="container">
        ...
        <main className="block mb-1">
          <Content size={5} className="is-family-secondary has-text-black p-5 mb-1">
            <span className="has-text-weight-semibold">1. Initial Quality Sweep, Manual Context Review, Establish structural base</span>: <span className="is-italic">survey_data_master_raw.csv</span>{' '}
          ...
          <Content size={5} className="is-family-secondary has-text-black p-5 mb-1">
            <span className="has-text-weight-semibold">
              2. Dataset Truncation (Simple Random Sampling), <span className="is-italic">Python</span> Program Execution, Select representative subset of dataset
            </span>
            ...
            (random_state=75) to enforce reproducibility, 85 unique survey responses were randomly selected from the 275 data rows following the{' '}
          ...
          <Content size={5} className="is-family-secondary has-text-black p-5 mb-1">
            <span className="has-text-weight-semibold">3. Complete Quality Sweep and Song URL Insertion, Manual Context Review, Remove invalid data and systematically correct information</span>: While
          ...
          <Content size={5} className="is-family-secondary has-text-black p-5 mb-1">
            <span className="has-text-weight-semibold">
              4. Primary Feeling Mapping, <span className="is-italic">Python</span> Program Execution, Map each remaining primary feeling in the <span className="is-italic">[primary_feeling]</span>{' '}
          ...
          <Content size={5} className="is-family-secondary has-text-black p-5 mb-1">
            <span className="has-text-weight-semibold">
              5. Song Downloading and <span className="is-italic">WAV</span> Conversion, <span className="is-italic">Python</span> Program Execution, Download each song in the{' '}
              <span className="is-italic">[song_name]</span> column through the corresponding URL in the <span className="is-italic">[youtube_music_url]</span> column and convert to{' '}
          ...
          <Content size={5} className="is-family-secondary has-text-black p-5 mb-1">
            <span className="has-text-weight-semibold">
              6. <span className="is-italic">Essentia</span> Sonic Feature Extraction, <span className="is-italic">Python</span> Program Execution, Calculate and record 12 sonic scalar values for each
          ...
          <Content size={5} className="is-family-secondary has-text-black p-5 mb-1">
            <span className="has-text-weight-semibold">
              7. Sonic Feature Scalar Standardization, <span className="is-italic">Python</span> Program Execution, Standardize the 12 sonic scalar values for each of the 45 remaining data rows
            </span>
          ...
          <Content size={5} className="is-family-secondary has-text-black p-5 mb-1">
            <span className="has-text-weight-semibold">
              8. <span className="is-italic">PCA</span> Dimensionality Reduction, <span className="is-italic">Python</span> Program Execution, Compress 12 multi-dimensional standardized sonic features
