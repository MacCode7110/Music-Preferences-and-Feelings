      ...
      <div className="container">
        <header className="block mb-1">
          ...
          <Content size={5} className="is-family-secondary has-text-black p-5">
            ...
            were utilized to build <span className="is-italic">Exploratory PCA: Musical Qualities and Mapping Feelings</span>. The 275 survey responses stored in{' '}
            ...
            presented through <span className="is-italic">Exploratory PCA: Musical Qualities and Mapping Feelings</span>.
          </Content>
        </header>
